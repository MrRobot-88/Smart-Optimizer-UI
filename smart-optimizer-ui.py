...
<div class="panel"><div class="panelhead"><div><h3>Settings &amp; status</h3><p>Current Radarr configuration and system status.</p></div><a class="badge" href="/settings">CONFIG</a></div>%s</div>
</div>
<div>
...
<div class="panel"><div class="panelhead"><div><h3>Settings &amp; status</h3><p>Current configuration and system status.</p></div><a class="badge" href="/settings">CONFIG</a></div><div class="sidecontent">
<div class="metricline"><span>Downsize range</span><b>%.1f – %.1f%%</b></div>
